export class TerrainEditor {
  ...
  handlePointerDown(evt) {
    ...
    if (pickInfo.hit) {
      this.selectedObject = this.addObjectAtLocation(this.currentTool, pickInfo.pickedPoint);
  ...
  float sway = sin(position.x * 2.0 + iTime * swaySpeed) * swayStrength;
      ...
      if (templateIndex === 2) {
        //for tree imports
        this.objectTemplates[templateIndex].material.environmentIntensity = 0.25;
        this.objectTemplates[templateIndex].material.directIntensity = 10.2;
        ...
        const standardMat = new BABYLON.StandardMaterial("templateMat", this.scene);
  ...
  getPickInfo() {
    return this.scene.pick(this.scene.pointerX, this.scene.pointerY, (mesh) => mesh === this.mesh);
  }
