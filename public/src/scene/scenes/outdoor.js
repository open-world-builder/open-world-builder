...
function createSkydome(scene) {
  ...
  skyboxMaterial.reflectionTexture = new BABYLON.CubeTexture(
    "./assets/textures/lighting/skybox",
    scene
  );
...
function addShaders(scene, engine) {
  ...
  function creatDebug() {
    ...
    createSlider("Radius", 0.0, 5.0, 2.0, 0.1, (value) =>
      orbMaterial.setFloat("Radius", value)
    );
    createSlider("Noise Amplitude", 0.0, 1.0, 0.09, 0.01, (value) =>
      orbMaterial.setFloat("NoiseAmplitude", value)
    );
    createSlider("Noise Frequency", 0.0, 5.0, 1.2, 0.1, (value) =>
      orbMaterial.setFloat("NoiseFrequency", value)
    );

    createColorPicker(
      "Color1",
      BABYLON.Color3.FromHexString("#640000"),
      (color) => {
        orbMaterial.setVector4(
          "Color1",
          new BABYLON.Vector4(color.r, color.g, color.b, 1.0)
        );
      }
    );
    ...
    createColorPicker(
      "Color2",
      BABYLON.Color3.FromHexString("#ff4d00"),
      (color) => {
        orbMaterial.setVector4(
          "Color2",
          new BABYLON.Vector4(color.r, color.g, color.b, 1.0)
    ...
    createColorPicker(
      "Color3",
      BABYLON.Color3.FromHexString("#ff0a00"),
      (color) => {
        orbMaterial.setVector4(
          "Color3",
          new BABYLON.Vector4(color.r, color.g, color.b, 1.0)
    ...
    createColorPicker(
      "Color4",
      BABYLON.Color3.FromHexString("#0d0505"),
      (color) => {
        orbMaterial.setVector4(
          "Color4",
          new BABYLON.Vector4(color.r, color.g, color.b, 1.0)
...
function createTrailFire(scene, engine, sphere) {
  ...
  SHADERS["fireTrailShader"].transparencyMode =
